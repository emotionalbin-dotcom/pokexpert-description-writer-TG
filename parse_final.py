...
protoc_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "protoc_bin", "bin", "protoc.exe")
...
pokedex_matches = re.findall(r'  3 \{\n    .*?    3 \{\n(.*?)    \}\n  \}', full_content, re.DOTALL)
pokedex_unique = 0
pokedex_shiny = 0
...
legendaries = {
    ...
    "800",
    "888", "889", "890", "891", "892", "894", "895", "896", "897", "898", "899", "900", "901", "905",
...
lines.append("🐍 [Snake Form Zygarde checked below]")
lines.append("")
